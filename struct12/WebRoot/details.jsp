			...
			<div class="container">
				...
				<div class="left fl">
					<div class="right-extra" style="margin-top:10px;">
						<!--产品参数开始-->
						<div>
							<div id="preview" class="spec-preview"> <span class="jqzoom"><img jqimg="img/bg1.png" src="img/sm1.png" /></span> </div>
							<!--缩图开始-->
							<div class="spec-scroll">
								...
								<div class="items">
									<ul>
										<li><img alt="佳能" bimg="img/bg1.png" src="img/sm1.png" onmousemove="preview(this);"></li>
										<li><img alt="佳能" bimg="img/bg2.png" src="img/sm2.png" onmousemove="preview(this);"></li>
										<li><img alt="佳能" bimg="img/bg3.png" src="img/sm3.png" onmousemove="preview(this);"></li>
										<li><img alt="佳能" bimg="img/bg4.png" src="img/sm4.png" onmousemove="preview(this);"></li>
										<li><img alt="佳能" bimg="img/bg5.png" src="img/sm5.png" onmousemove="preview(this);"></li>
										<li><img alt="佳能" bimg="img/bg6.png" src="img/sm6.png" onmousemove="preview(this);"></li>
				...
				<div class="right fr">
					<ul>
						<li class="font_size16 blod">华为 畅想6S 金色 移动联通电信4G手机 双卡双待</li>
							...
							<div class="activity">
								...
								<div class="row">
									...
									<div class="row_right fl">
										<span class="redcolor font_size16">¥1499</span>
										<del class="font_size16">¥1999</del>
									</div>
									<div class="clear">
