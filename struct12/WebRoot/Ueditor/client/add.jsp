...
<body>
	<div class="col-xs-12 col-sm-12">
			...
			<form class="f1 form-horizontal" action="client/insert1"
				...
				<div class="col-sm-2 col-xs-2 "></div>
					...
					<div class="col-sm-9 col-xs-9 ">
						<input type="text" id="form-field-1" placeholder="Account"
							class="col-xs-9 col-sm-6 must" name="tel" />
					</div>
				</div>
				<div class="form-group">
				<div class="col-sm-2 col-xs-2 "></div>
					...
					<div class="col-sm-9 col-xs-9 ">
						<input type="text" id="form-field-1" placeholder="Username"
							class="col-xs-9 col-sm-6 must" name="nickname" />
					</div>
				</div>
				<div class="form-group ">
				<div class="col-sm-2 col-xs-2 "></div>
					...
					<div class="col-sm-9 col-xs-9 ">
						<input type="text" id="form-field-1" placeholder="Username"
							class="col-xs-9 col-sm-6 must" name="email"/>
					</div>
				</div>
				<div class="form-group ">
				<div class="col-sm-2 col-xs-2 "></div>
					...
					<div class="col-sm-9 col-xs-9 ">
						<input type="text" id="form-field-1" placeholder="Username"
							class="col-xs-9 col-sm-6 must" name="pass"/>
					</div>
				</div>
				...
				<div class="col-sm-2 col-xs-2 "></div>
					<label class="col-sm-2 col-xs-2 control-label no-padding-right"
						for="form-field-1">选择密保</label>
					<div class="col-sm-8 col-xs-8 ">
				<select name="status" class="col-xs-8 col-sm-8" name="status" class="must">
						<c:forEach items="${requestScope.questionlist}" var="r" varStatus="v">
				...
				<div class="col-sm-2 col-xs-2 "></div>
					<label class="col-sm-2 col-xs-2 control-label no-padding-right"
						for="form-field-1">密保答案</label>
					<div class="col-sm-8 col-xs-8 ">
						<input type="text" id="form-field-1" placeholder="Username"
							class="col-xs-9 col-sm-6 must" name="answer"/>
					</div>
				</div>
		...
		<c:if test="${requestScope.uplist!=null}">
			<form class="f1 form-horizontal" action="client/update1" method="post">
			...
			<div class="col-sm-2 col-xs-2 "></div>
				...
				<div class="col-sm-2 col-xs-2 "></div>
					...
					<div class="col-sm-9 col-xs-9 ">
						<input type="text" id="form-field-1" placeholder="Username"
							class="col-xs-9 col-sm-6" name="nickname" class="must" value="${requestScope.uplist.nickname}"/>
					</div>
				</div>
				...
				<div class="col-sm-2 col-xs-2 "></div>
					...
					<div class="col-sm-9 col-xs-9 ">
						<input type="text" id="form-field-1" placeholder="Username"
							class="col-xs-9 col-sm-6" name="email" class="must" value="${requestScope.uplist.email}"/>
					</div>
				</div>
				...
				<div class="col-sm-2 col-xs-2 "></div>
					...
					<div class="col-sm-9 col-xs-9 ">
						<input type="text" id="form-field-1" placeholder="Username"
							class="col-xs-9 col-sm-6" name="comments" class="must" value="${requestScope.uplist.comments}"/>
					</div>
				</div>
			</form>
		</c:if>
