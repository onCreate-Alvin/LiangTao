...
<body>
	<div class="col-xs-12 col-sm-12">
		<c:if test="${requestScope.uplist==null}">
			<form class="f1 form-horizontal" action="order/insert1"
		...
		<c:if test="${requestScope.uplist!=null}">
			<form class="f1 form-horizontal" action="order/update1" method="post">
			...
			<div class="col-sm-2 col-xs-2 "></div>
				...
				<div class="col-sm-2 col-xs-2 "></div>
					<label class="col-sm-2 col-xs-2 control-label no-padding-right"
						for="form-field-1">出货状态</label>
					<div class="col-sm-8 col-xs-8">
				<select name="status" class="col-xs-8 col-sm-8" name="status" class="must">
						<c:forEach items="${requestScope.orderstatus}" var="r3" varStatus="v">
