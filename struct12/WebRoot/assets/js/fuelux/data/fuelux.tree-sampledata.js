...
var tree_data = {
	'productms' : {name: '商品管理', type: 'folder',id:2}	,
	'clientms' : {name: '用户管理', type: 'folder',id:5}	,
	'orderms' : {name: '订单管理', type: 'folder',id:7}	,
	'shopcarms' : {name: '购物车管理', type: 'folder' ,id:9},
	'operatorms' : {name: '管理员管理', type: 'item',id:1}	
	
}
tree_data['productms']['additionalParameters'] = {
	'children' : {
		'product' : {name: '商品管理', type: 'item',id:3},
		'productType' : {name: '商品类型管理', type: 'item',id:4}
	}
}
tree_data['clientms']['additionalParameters'] = {
	'children' : {
		'client' : {name: '用户', type: 'item',id:6}
	}
}
tree_data['orderms']['additionalParameters'] = {
	'children' : {
		'order' : {name: '权限', type: 'item',id:8}
	}
}
tree_data['shopcarms']['additionalParameters'] = {
	'children' : {
		'shopcar' : {name: '购物车', type: 'item',id:10}
	}
}
