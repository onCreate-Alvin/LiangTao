...
<body>
	<div class="col-xs-12 col-sm-12">
		<c:if test="${requestScope.uplist==null}">
			<form class="f1 form-horizontal" action="operator/insert1"
				...
				<div class="col-sm-2 col-xs-2 "></div>
					...
					<div class="col-sm-9 col-xs-9 ">
						<input type="text" id="form-field-1" placeholder="Account"
							class="col-xs-9 col-sm-6 must" name="account" />
					</div>
				</div>
				...
				<div class="col-sm-2 col-xs-2 "></div>
					...
					<div class="col-sm-9 col-xs-9 ">
						<input type="text" id="form-field-1" placeholder="Username"
							class="col-xs-9 col-sm-6" name="comments" class="must" />
					</div>
				</div>
			</form>
		</c:if>
		<c:if test="${requestScope.uplist!=null}">
			<form class="f1 form-horizontal" action="operator/update1" method="post">
			...
			<div class="col-sm-2 col-xs-2 "></div>
				...
				<div class="col-sm-2 col-xs-2 "></div>
					...
					<div class="col-sm-9 col-xs-9 ">
						<input type="text" id="form-field-1" placeholder="Account"
							class="col-xs-9 col-sm-6" name="account" class="must" value="${requestScope.uplist.account}" />
					</div>
				</div>
				<div class="form-group">
				<div class="col-sm-2 col-xs-2 "></div>
					...
					<div class="col-sm-9 col-xs-9 ">
						<input type="text" id="form-field-1" placeholder="Username"
							class="col-xs-9 col-sm-6" name="name" class="must" value="${requestScope.uplist.name}"/>
					</div>
				</div>
				...
				<div class="col-sm-2 col-xs-2 "></div>
					...
					<div class="col-sm-9 col-xs-9 ">
						<input type="text" id="form-field-1" placeholder="Username"
							class="col-xs-9 col-sm-6" name="tel" class="must" value="${requestScope.uplist.tel}"/>
					</div>
				</div>
				...
				<div class="col-sm-2 col-xs-2 "></div>
					<label class="col-sm-1 col-xs-1 control-label no-padding-right"
						for="form-field-1">comments</label>
					<div class="col-sm-9 col-xs-9 ">
						<input type="text" id="form-field-1" placeholder="Username"
