			...
			<div class="top">
				...
				<div class="right fr">
					<div class="border">
						...
						<div class="select fl">
							<select name="">
								<option value=""> <a href="shopcar.htm">去购物车结算</a> </option>
								<option value=""> <a href="clearshopcar">清空购物车</a> </option>
							</select>
						</div>
						<div class="clear">
			...
			<div class="container">
				...
				<div class="left fl">
					<div class="right-extra" style="margin-top:10px;">
						<!--产品参数开始-->
						<div>
							<div id="preview" class="spec-preview"> <span class="jqzoom"><img jqimg="${requestScope.product.ps[0].url}" src="${requestScope.product.ps[0].url}" style="width: 350px"/></span> </div>
							<!--缩图开始-->
							<div class="spec-scroll">
								...
								<div class="items">
									<ul>
										<c:forEach var="r" items="${requestScope.product.ps}">
